...
In order to determine the performance of our model we wanted to backtest it across a period of 10 years, comparing our model’s predictions against real market performance. For the results in Figure 3, this was done on a subset of our dataset, containing only 5\% of the data we had merged together. 
